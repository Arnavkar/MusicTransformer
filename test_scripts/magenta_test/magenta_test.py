...
def setup():
    print(os.getcwd())
    #Create dirs
    if not os.path.exists("./content/gansynth"):
        os.makedirs("./content/gansynth/")
        os.makedirs("./content/gansynth/midi")
        os.makedirs("./content/gansynth/samples")

    #Download files
    if not os.path.exists("./content/gansynth/midi/bach.mid"):
        urllib.request.urlretrieve("http://www.jsbach.net/midi/cs1-1pre.mid","./content/gansynth/midi/bach.mid")

    if not os.path.exists("./content/gansynth/midi/riff-default.mid"): 
        urllib.request.urlretrieve("http://storage.googleapis.com/magentadata/papers/gansynth/midi/arp.mid", "./content/gansynth/midi/riff-default.mid")

    files = os.listdir("./content/gansynth/midi")
