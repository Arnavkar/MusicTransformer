...
midi_test_params_v2 = {
    ...
    "key_dim": 64,  # Dimensionality of linearly projected queries and keys
    "value_dim": 64,  # Dimensionality of linearly projected values
    "model_dim":384,  # Dimensionality of the model final output
    ...
    "encoder_seq_len": 512, #Encoder input sequence length -  context sequence
    "decoder_seq_len": 514, #Decoder sequence length - larger by two because we add sos and eos tokens
    "max_seq_len":514, #Maximum sequence length - used for positional encoding
