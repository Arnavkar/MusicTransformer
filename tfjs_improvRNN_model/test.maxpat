...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.0, 472.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1100.0, 1089.0, 50.0, 263.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 509.0, 477.0, 581.0, 35.0 ],
					"text" : "60 35 120 1.008333 64 37 120 1.558333 67 40 120 2.133333 70 42 120 2.733333 74 32 120 3.333333 81 32 120 4.008333"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 697.0, 36.0, 308.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1085.0, 232.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 682.0, 21.0, 308.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1070.0, 217.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1036.0, 183.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1040.0, 159.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1052.0, 139.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1204.0, 615.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 667.0, 184.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 216.0, 244.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1007.0, 798.0, 150.0, 20.0 ],
					"text" : "stock duration"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 952.0, 839.0, 29.5, 22.0 ],
					"text" : "120"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 696.5, 709.0, 29.5, 22.0 ],
					"text" : "- 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.0, 639.0, 29.5, 22.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1167.0, 106.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 497.0, 597.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 198.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 46.0, 258.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 1103.25, 439.0, 87.0, 60.0 ],
					"text" : "manually flush the stored items in the queue"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 836.0, 379.0, 109.0, 22.0 ],
					"text" : "pack sym 0 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 176.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 46.0, 236.0, 150.0, 20.0 ],
					"text" : "QPM (tempo)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 143.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 46.0, 203.0, 150.0, 20.0 ],
					"text" : "is it dotted? (T/F)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 667.0, 141.0, 400.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 216.0, 201.0, 400.0, 22.0 ],
					"style" : "velvet",
					"tabs" : [ "0", "1" ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "beat division (of whole note)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 984.0, 607.0, 155.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 497.0, 244.0, 57.0, 57.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 885.0, 682.5, 336.0, 53.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 12.5, 641.0, 468.0, 500.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 216.0, 386.0, 137.0, 22.0 ],
...
,
					"text" : "node.script improvisor.js"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 961.5, 901.0, 933.166666666666629, 901.0 ],
					"source" : [ "obj-104", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 676.5, 339.0, 935.5, 339.0 ],
					"order" : 0,
					"source" : [ "obj-119", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 867.0, 70.0, 1077.0, 70.0, 1077.0, 252.0, 863.5, 252.0 ],
					"order" : 1,
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 867.0, 105.0, 1076.0, 105.0, 1076.0, 240.0, 881.5, 240.0 ],
					"order" : 2,
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 867.0, 136.0, 1078.0, 136.0, 1078.0, 226.0, 899.5, 226.0 ],
					"source" : [ "obj-29", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 867.0, 219.0, 917.5, 219.0 ],
					"source" : [ "obj-32", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 506.5, 630.0, 623.375, 630.0 ],
					"order" : 0,
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 623.375, 702.0, 681.0, 702.0, 681.0, 696.0, 716.5, 696.0 ],
					"source" : [ "obj-78", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 506.5, 775.0, 623.375, 775.0 ],
					"order" : 1,
					"source" : [ "obj-83", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-92", 1 ],
					"midpoints" : [ 706.0, 732.0, 654.375, 732.0 ],
					"source" : [ "obj-93", 0 ]
				}
